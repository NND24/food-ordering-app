    ...
    <div className='px-[20px] md:pt-[110px] pb-[100px] bg-white'>
      ...
      {orderDetail ? (
            ...
            <div className='flex flex-col items-center justify-center py-[20px]'>
              ...
              {orderDetail && (
                <span className='text-[#636464] text-[18px] text-center'>
                  Bạn thấy món ăn hoặc thức uống từ <span class='rating-store-name'>{orderDetail.data.store.name}</span>{" "}
                  như thế nào?
                </span>
              )}
              <span className='text-[#636464] text-[18px] text-center ordered-dishes'>
                Đã đặt:{" "}
                {orderDetail &&
        ...
        <div className='px-[20px] md:w-[90%] md:mx-auto'>
          <h3 className='no-current-orders text-[20px] text-[#4a4b4d] font-semibold'>Không tìm thấy đơn hàng</h3>
        </div>
      )}
    </div>
  );
