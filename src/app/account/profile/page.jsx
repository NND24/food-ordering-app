...
const page = () => {
  ...
  return (
    <div className='pt-[30px] pb-[100px] px-[20px] md:pt-[75px] md:mt-[20px] md:px-0 bg-[#fff] md:bg-[#f9f9f9] dark:bg-gray-900'>
                ...
                <section className='w-full'>
                  <div {...getRootProps()}>
                    ...
                    <Image
                      ...
                      width={40}
                      height={40}
                      className='absolute bottom-[-4px] right-[-4px] object-contain z-10 p-[6px] rounded-full bg-[#f5f5f5] dark:bg-gray-700 shadow-[rgba(0,0,0,0.24)_0px_3px_8px]'
                    />
                  </div>
                </section>
              )}
