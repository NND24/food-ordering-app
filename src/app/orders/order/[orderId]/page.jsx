...
const page = () => {
  ...
  return (
    <div className='pb-[140px] bg-[#fff] md:bg-[#f9f9f9] md:pt-[110px]'>
      ...
      {orderDetail ? (
        <>
          {orderDetail.data.user === currentUser._id ? (
            <>
                ...
                <div className='bg-[#fff] flex flex-col m-[20px] p-[10px] border border-[#a3a3a3a3] border-solid rounded-[8px] shadow-[rgba(0,0,0,0.24)_0px_3px_8px] md:p-[20px]'>
                  ...
                  <div className='bg-[#fff]'>
                    {orderDetail.data.status !== "cancelled" && (
                      <h3 className='text-[#4A4B4D] text-[28px] font-bold'></h3>
                    )}
                    <span className='order-status text-[#4A4B4D] text-[18px]'>{status}</span>
                    ...
                    {orderDetail.data.status !== "cancelled" && (
                      <div className='relative flex items-center justify-between py-[10px]'>
                        ...
                        <Image
                          src={`/assets/delivery${
                            ["taken", "delivering", "delivered", "done"].includes(orderDetail.data.status)
                              ? "_active"
                              : ""
                          }.png`}
                          alt=''
                        ...
                        <Image
                          src={`/assets/home${
                            ["done", "delivered"].includes(orderDetail.data.status) ? "_active" : ""
                          }.png`}
                          alt=''
                          width={25}
                          height={25}
