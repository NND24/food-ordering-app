...
const RatingBar = ({ ratings }) => {
  ...
  return (
    <div className='bg-[#e6e6e680] dark:bg-gray-700 m-[20px] rounded-[8px] md:mx-0 md:my-[20px]'>
      <div
        className='flex items-center gap-[6px] pb-[10px] px-[20px] pt-[20px] border-b-[3px] border-white dark:border-gray-600'
      >
        <span className='text-[#4A4B4D] dark:text-gray-100 text-[24px] font-bold'>{avgRating}</span>
            ...
            .map((star) => {
              ...
              return (
                <div key={star} className='flex items-center gap-[10px]'>
                  ...
                  <div className='flex-1 h-[10px] bg-[#d3d3d3] dark:bg-gray-600 rounded-[5px] overflow-hidden'>
                    <div
