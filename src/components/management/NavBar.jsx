    ...
    <div className='fixed bottom-0 right-0 left-0 pt-[5px] bg-[#fff] w-full h-[75px] px-[25px] shadow-[0px_-10px_40px_0px_rgba(110,110,110,0.45)]'>
      <div className='relative flex items-center justify-between h-full w-full'>
        ...
        <div className='flex items-center gap-[30px]'>
          <Link href='/management/home' className='flex flex-col  items-center gap-[1px]'>
            <Image
              src={`${page == "home" ? "/assets/home-active.png" : "/assets/home.png"}`}
              alt=''
              width={24}
              height={24}
            />
        ...
        <div className='flex items-center gap-[50px]'></div>
        <div className='flex items-center gap-[30px]'>
          <Link href='/management/orders' className='flex flex-col  items-center gap-[1px]'>
            <Image
        ...
        <div className='flex items-center gap-[20px]'>
          <Link href='#' className='flex flex-col  items-center gap-[1px]'>
            <Image
              src={`${page == "discount" ? "/assets/discount_active.png" : "/assets/discount.png"}`}
              alt=''
              width={24}
              height={24}
            />
            <p className={`text-[12px] mt-1 ${page == "discount" ? "text-[#fc6011]" : "text-[#4A4B4D]"}`}>khuyến mãi</p>
          </Link>
        </div>
        <div className='flex items-center gap-[20px]'></div>
      </div>
